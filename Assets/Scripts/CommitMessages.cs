...
public static class CommitMessages {
	public static string GetRandom() {
		return messages [Random.Range (0, messages.Length)];
	}

	// Shamelessly ripped from https://github.com/ngerakines/commitment/blob/master/commit_messages.txt
	// Date: 2015-07-21
	// Commit: e6e75ca394a9e3d4639d63564effd6fba7fdbcdb
